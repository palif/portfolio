<html>
	...
	<head>
		...
		<title> Skyltmontörerna | Kontakt </title>
...
<body>
	...
	**************************************************************************-->
	...
	<div id="first-container-contact" > 
		<div id="contact-detail-container" class="wrap-content">
			<div id="contact-info-content">
				<ul>
					<li class="contact-info-list"><a href="mailto:info@skyltmontorerna.se"><i class="icon-mail"></i><span> info@skyltmontorerna.se </span></a></li>
					<li class="contact-info-list"><a href="tel:070054441"><i class="icon-telephone"></i><span> 0700 544 441 </span></a></li>
					<li class="contact-info-list"><a href="tel:0704483057"><i class="icon-telephone"></i><span> 0704 483 057 </span></a></li>
					<li class="contact-info-list"><i class="icon-location"></i><span> Rotemannavägen 10 <br> 145 57 Norsborg </span></li>
					<li class="open-time-title"><span>Öppetider</span></a></li>
					<li class="open-time-wd"><span>Mån-Fre: 07:00 - 17:00 </span></a></li>
					<li class="open-time-wd"><span>Lör-Sön: Stängt </span></a></li>
				</ul>
			</div>
			<div id="contact-form-content">
				<form action="php/contactforum.php" method="post">
					<input type="text" name="name" placeholder="Namn*"><br>
					<input type="text" name="email" placeholder="E-postadress*"><br>
					<input type="text" name="telephone" placeholder="Telefon nummer*"><br>
					<textarea name="message" placeholder="Meddelande*"></textarea><br>
					<button type="submit" name="submit"><span> SKICKA </span></button>
				</form>
			</div>
			...
			<div class="footer-first-row">
				<nav>
					<ul>
						...
						<li><a href="instagram.com/skyltmontorerna" target="_blank"> <span> <i class="icon-instagram"> </i>  </span> </a></li>
